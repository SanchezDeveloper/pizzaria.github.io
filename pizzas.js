let pizzaJson = [
    ...
    {id:8, name:'MMs', img:'images/pizza7.png', price:27.56, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    {id:9, name:'Sonho de Valsa', img:'images/pizza7.png', price:24.50, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'}
];
